...
```{sh, eval=FALSE}
srun -p high -t 1:00:00 angsd -P 4 -b bamlists/hets318-edited.bamlist -minInd 51  -out outputs/1300/hets-omy20 -minMaf 0.05 -minMapQ 10 -minQ 20 -GL 1 -doMajorMinor 1 -doMaf 1 -SNP_pval 1e-6 -doGeno 4 -doPost 1 -postCutoff 0.95 -doPlink 2 -r omy20 > outputs/1300/hets.stdout 2> outputs/1300/hets.stderr &
...
```
```{r}
filtered<-ld %>% filter(R2>=0.8) %>% arrange(R2)

ggplot(filtered, aes(x=BP_A, y=BP_B, color=R2)) +
  geom_point()+
  scale_color_gradient(low="gray",high="red")+
  theme_bw()

ggsave("outputs/1300/hets-troutomy20-ld.pdf")
```
