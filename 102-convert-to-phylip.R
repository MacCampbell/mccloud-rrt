...
# ./102-convert-to-phylip.R path-to-file file bamlist
# ./102-convert-to-phylip.R outputs/100/ test.geno.gz bamlists/test.bamlist
...
write(cbind(inds, characters)[1:2], file=paste(dir,basename,".phy",sep="")) #put header in
write.table(trans, file=paste(dir,basename,".phy",sep=""), append=TRUE, quote = FALSE, sep="", row.names = TRUE, col.names=FALSE)
