...
#(py3) Macs-MBP-2:temp mac$ conda install pandas
#(py3) Macs-MBP-2:temp mac$ conda install numpy
#(py3) Macs-MBP-2:temp mac$ conda install biopython
#Macs-MBP-2:temp mac$ source deactivate
